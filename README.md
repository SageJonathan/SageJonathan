...
Currently building AI annotation systems at **Meta** while founding **Humanae Inc** (professional networking platform) and running **SageCodes Ltd** (consulting practice serving e-commerce & SaaS clients).
...
- 🌐 **Humanae Inc (Founder)** - Building real-time networking platform with smart matching & encrypted messaging
